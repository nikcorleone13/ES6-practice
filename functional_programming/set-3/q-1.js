// Write an ES6 function that takes an array of objects representing cars with properties make, 
...
const cars = [
  ...
  // Your code here
  const findToyotaCar = find.cars((cars) => cars.make == 'Toyota' && cars.year > 2010);
